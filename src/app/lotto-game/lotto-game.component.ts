...
export class LottoGameComponent implements OnInit {
  ...
  private p3ls: Pick3LogicService) { }
  ...
  onOffLottoGame(): void {
    (this.userLotto) ? this.userLotto = undefined : this.userLotto = {game: this.lottoGame};
      if (this.userLotto && this.userLotto.game.logic === 1) {
        this.userLotto.userLotteryList = this.p3ls.genLottos(this.userLotto.game);
      }
  }
}
